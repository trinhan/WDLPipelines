## Modified from GATK version 1.5.1
## Changes:
## 1. Embed GenerateSampleMap in WF. This takes in a sampleset with a list of sampleNames and SamplePaths
## 2. Modify the minimum number of samples needed for joint calling (by default 50)
...
workflow JointGenotyping {
  ...
  call GenerateSampleMap.GenerateSampleMapFile as GenerateSampleMap {
    input:
      sample_names = sample_names,
      file_paths = file_paths,
      outfile = callset_name + ".sample_map"
  }
  ...
  Array[Array[String]] sample_name_map_lines = read_tsv(GenerateSampleMap.sample_map)
