# Run Funcotator on a set of Segments from GATK4 gCNV. Modified from script for Model Segments
# Note there is an additional optional parameter:
# is_vcf = true by default. Is the input file a vcf?
#
...
workflow CNVFuncotateSegmentsWorkflow {
    ...
    File input_seg_file = select_first([VCF2Seg.seg_file, input_file])
...
task VCF2Seg{
    ...
    # copied from https://gatk.broadinstitute.org/hc/en-us/articles/360035531452-After-gCNV-calling-considerations#1
